      ...
      <div>
        {
          ...
          <div className="App">
            ...
            <ChooseCard image={this.state.pokemon2.sprites.front_default} name={this.state.pokemon2.name} type={this.state.pokemon2.types.lenght>=2 ? [this.state.pokemon2.types[0].type.name,this.state.pokemon2.types[1].type.name]:[this.state.pokemon2.types[0].type.name]} id="1" pv='70' />
          </div>
          ):
          <p>LOADING</p>
        }
